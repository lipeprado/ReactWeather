	    ...
	    render: function render() {
	        ...
	        function renderMessage() {
	            if (isLoading) {
	                ...
	                return React.createElement(WeatherMessage, { location: location, description: description, country: country, temp: temp });
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var WeatherMessages = function WeatherMessages(_ref) {
	    var temp = _ref.temp,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?&appid=c73c7f12ad6da38694a31235450ab487&units=metric';
